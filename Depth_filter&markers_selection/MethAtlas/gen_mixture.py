...
for i in [15, 20, 25, 30, 35, 40, 45, 50, 60, 70, 80, 90, 100]:
    ref_df = pd.read_csv(f'/home/sty/cfDNA_benchmark/meth_atlas_data/ref_median_{i}/ref_depth_{i}_unique.csv')
    input_dir = f"/home/sty/cfDNA_benchmark/benchmark_pat/pat_merged/mix"
    output_dir = f"/home/sty/cfDNA_benchmark/meth_atlas_data/uniform/ref_median_{i}"
    file_extension = "*.beta"
