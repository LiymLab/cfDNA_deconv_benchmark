...
#data_full <- read.table('~/celfeer_work1/median_depth_filter/median_15/full_data_input_median_15.txt',skip = 1)
#colnames_all <- strsplit(readLines('~/celfeer_work1/median_depth_filter/median_15/full_data_input_median_15.txt',n=1),split = '\t')[[1]]
...
for(i in 1:length(tissues_drop)){
  ...
  col_name <- paste0('/dfs5/weil21-lab/yumeil1/tmp/celfeer_work1/celfeer_drop_tissues/data_median_15_drop_',tissue1,'_',tissue2,'/colnames.txt')
  data_name <- paste0('/dfs5/weil21-lab/yumeil1/tmp/celfeer_work1/celfeer_drop_tissues/data_median_15_drop_',tissue1,'_',tissue2,'/data_input.txt')
  #col_name <- paste0('~/celfeer_work1/celfeer_drop_tissues/data_median_15_drop_',tissue1,'_',tissue2,'/colnames.txt')
  #data_name <- paste0('~/celfeer_work1/celfeer_drop_tissues/data_median_15_drop_',tissue1,'_',tissue2,'/data_input.txt')
