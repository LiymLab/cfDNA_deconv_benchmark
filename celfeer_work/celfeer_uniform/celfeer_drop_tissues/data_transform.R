...
for(i in 1:length(tissues_drop)){
  ...
  read_name <- paste0('~/celfeer_work1/celfeer_drop_tissues/data_median_15_drop_',tissue1,'_',tissue2,'/data_median_15_drop_',tissue1,'_',tissue2,'_output/1_tissue_proportions.txt')
  ...
  output_name <- paste0('~/celfeer_work1/celfeer_drop_tissues/data_median_15_drop_',tissue1,'_',tissue2,'/t_tissue_proportions.csv')
