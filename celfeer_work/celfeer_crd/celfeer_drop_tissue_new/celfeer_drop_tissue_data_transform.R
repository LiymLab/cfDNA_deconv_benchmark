...
for(i in c('Blood-NK','Blood-Granul','Blood-Mono+Macro','Blood-B','Blood-T')){
  read_name <- paste0('/home/zyc/celfeer_work2/celfeer_drop_tissue_new/data_median_15_drop_',i,'/data_median_15_drop_',i,'_output/1_tissue_proportions.txt')
  ...
  output_name <- paste0('/home/zyc/celfeer_work2/celfeer_drop_tissue_new/data_median_15_drop_',i,'/t_tissue_proportions.csv')
