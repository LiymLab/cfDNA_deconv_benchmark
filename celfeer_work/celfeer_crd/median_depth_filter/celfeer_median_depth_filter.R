...
for(i in c(15,20,25,30,35,40,45,50,60,70,80,90,100)){
  pearson_result_name <- paste0('/home/zyc/celfeer_work2/median_depth_filter/median_',i,'/pearson_result_median_',i,'.csv')
  rmse_result_name <- paste0('/home/zyc/celfeer_work2/median_depth_filter/median_',i,'/rmse_result_median_',i,'.csv')
...
pearson_results_name <- '/home/zyc/celfeer_work2/median_depth_filter/celfeer_cfsort_pearson_res_combined.csv'
rmse_results_name <- '/home/zyc/celfeer_work2/median_depth_filter/celfeer_cfsort_rmse_res_combined.csv'
