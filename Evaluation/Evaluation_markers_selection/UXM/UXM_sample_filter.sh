...
do
    ...
    do
	  ...
	  #${j}/${m}/*pat.gz: one or more pat files to deconvolve.If you need to study the impact of sequencing depth on samples, you can use the script mix_downsample.py to generate pat.gz files for the samples.
    #$m: different sequencing depth of the samples	
    #--atlas: path to atlas generated by uxm build.
 	    for m in 1 5 10 15
			  uxm deconv ${j}/${m}/*pat.gz -o output_dir/depth_filter/${j}_deconv_out//sample_$m/depth_${i}.csv --atlas output_dir/selected_markers/filter_${i}_markers/Atlas.d${i}.l5.hg38.tsv 
   		done
    done
done
