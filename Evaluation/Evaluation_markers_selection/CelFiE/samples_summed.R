...
file_names <- list.files('/home/sty/cfDNA_benchmark/benchmark_pat/pat_merged/ref/') # path storing reference data; change the path according to your actual situation
