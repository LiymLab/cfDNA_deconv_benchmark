...
do
    ...
    uxm build --markers output_dir/selected_markers/filter_15_markers/filter_15_markers.bed --groups drop_${i}_group.csv --pats ref_dir/*pat.gz -o output_dir/selected_markers/filter_15_markers/Atlas.d15.l5.hg38.tsv -l 5
