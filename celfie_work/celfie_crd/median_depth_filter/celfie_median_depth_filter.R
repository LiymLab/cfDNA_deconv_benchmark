pearson_results <- data.frame(matrix(nrow = 100,ncol = 0))     #创建矩阵用于拼接数据
...
for(i in c(15,20,25,30,35,40,45,50,60,70,80,90,100)){
  pearson_result_name <- paste0('/home/zyc/celfie_work2/median_depth_filter/median_',i,'/pearson_result_median_',i,'.csv')
  rmse_result_name <- paste0('/home/zyc/celfie_work2/median_depth_filter/median_',i,'/rmse_result_median_',i,'.csv')
  ...
  colname <- paste0('median_depth_filter_',i)
...
pearson_results_name <- '/home/zyc/celfie_work2/median_depth_filter/celfie_cfsort_pearson_res_combined.csv'
rmse_results_name <- '/home/zyc/celfie_work2/median_depth_filter/celfie_cfsort_rmse_res_combined.csv'
