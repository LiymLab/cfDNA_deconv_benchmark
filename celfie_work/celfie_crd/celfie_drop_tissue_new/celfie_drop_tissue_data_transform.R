...
for(i in c('Blood-NK','Blood-Granul','Blood-Mono+Macro','Blood-B','Blood-T')){
  read_name <- paste0('/home/zyc/celfie_work2/celfie_drop_tissue_new/data_median_15_drop_',i,'/data_median_15_drop_',i,'_output/1_tissue_proportions.txt')
  tissue_proportions <- fread(read_name,header = FALSE,check.names = FALSE)
  tissue_proportions[1,1] <- 'ID'     #填充'ID'信息
  ...
  output_name <- paste0('/home/zyc/celfie_work2/celfie_drop_tissue_new/data_median_15_drop_',i,'/t_tissue_proportions.csv')
