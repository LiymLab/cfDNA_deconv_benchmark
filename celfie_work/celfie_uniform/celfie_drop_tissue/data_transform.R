...
for(i in c('Endothelium','Blood-Granul','Adipocytes','Blood-NK','Head-Neck-Ep')){
  read_name <- paste0('~/celfie_drop_tissue/data_median_15_drop_',i,'/median_15_drop_',i,'_output/1_tissue_proportions.txt')
  ...
  output_name <- paste0('~/celfie_drop_tissue/data_median_15_drop_',i,'/t_tissue_proportions.csv')
