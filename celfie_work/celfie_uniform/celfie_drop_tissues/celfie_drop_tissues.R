...
data_full <- read.table('~/celfie_work1/median_15/data_input_median_15.txt',header = TRUE,check.names = FALSE)
...
for(i in 1:length(tissues_drop)){
  ...
  data_name <- paste0('~/celfie_drop_tissues/data_median_15_drop_',tissue1,'_',tissue2,'/data_input.txt')
