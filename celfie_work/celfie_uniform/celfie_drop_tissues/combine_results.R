...
for(i in c('Endothelium','Blood-Granul','Adipocytes','Blood-NK','Head-Neck-Ep')){
  pearson_name <- paste0('~/celfie_drop_tissue/data_median_15_drop_',i,'/pearson_result_drop_',i,'.csv')
  rmse_name <- paste0('~/celfie_drop_tissue/data_median_15_drop_',i,'/rmse_result_drop_',i,'.csv')
...
for(j in 1:length(tissues_drop)){
  ...
  pearson_name <- paste0('~/celfie_drop_tissues/data_median_15_drop_',tissue1,'_',tissue2,'/pearson_result_drop_',tissue1,'_',tissue2,'.csv')
  rmse_name <- paste0('~/celfie_drop_tissues/data_median_15_drop_',tissue1,'_',tissue2,'/rmse_result_drop_',tissue1,'_',tissue2,'.csv')
...
write.table(rmse_results,file = '~/celfie_drop_tissue/celfie_drop_cell_type_rmse_results.csv',sep = ',',quote = FALSE,col.names = TRUE,row.names = FALSE)
write.table(pearson_results,file = '~/celfie_drop_tissue/celfie_drop_cell_type_pearson_results.csv',sep = ',',quote = FALSE,col.names = TRUE,row.names = FALSE)
