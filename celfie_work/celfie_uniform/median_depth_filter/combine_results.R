...
for(i in c(15,20,25,30,35,40,45,50,60,70,80,90,100)){
  pearson_result_name <- paste0('/home/zyc/celfie_work1/median_',i,'/pearson_result_median_',i,'.csv')
  rmse_result_name <- paste0('/home/zyc/celfie_work1/median_',i,'/rmse_result_median_',i,'.csv')
...
pearson_results_name <- '/home/zyc/celfie_work1/celfie_uniform_pearson_res_combined.csv'
rmse_results_name <- '/home/zyc/celfie_work1/celfie_uniform_rmse_res_combined.csv'
