...
#results of rmse results
rmse_output = sys.argv[2]
#results of pearson results
pearson_output = sys.argv[3]

# 读取 uniform_matrix_d.csv/crd_matrix_d.csv 文件
#traget path:
#uniform: /home/sty/cfDNA_benchmark/benchmark_pat/uniform_dis/uniform_matrix_d.csv
#crd: /home/sty/cfDNA_benchmark/benchmark_pat/crd_dis/crd_dis.csv
